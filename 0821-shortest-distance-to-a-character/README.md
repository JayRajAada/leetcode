<h2><a href="https://leetcode.com/problems/shortest-distance-to-a-character">821. Shortest Distance to a Character</a></h2>
<h3>Easy</h3>
<hr>

<p>Given a string <code>s</code> and a character <code>c</code> that occurs in <code>s</code>, return <em>an array of integers <code>answer</code> where <code>answer.length == s.length</code> and <code>answer[i]</code> is the <strong>distance</strong> from index <code>i</code> to the <strong>closest</strong> occurrence of character <code>c</code> in <code>s</code></em>.</p>
